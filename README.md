...
해 뜨는 아침 출근 시간, 과거의 나와 충돌하지 않고 모든 차량을 제시간에 보내세요!
...
- 초록 원(목적지)에 도착하면 다음 차량으로 넘어갑니다. (+10초 보너스)
...
- 가운데 가로 도로는 **고가도로(다리)** 로 세로 도로 위를 넘습니다. 램프로 오르내리며,
  다리 위의 차와 아래를 지나는 차는 서로 부딪히지 않습니다.
